...
const Login = () => {
    ...
    const { loginemail,loginpassword,result,setloginemail,setloginpassword,handlesubmitforloginpage,}=useContext(createUsercontextdata)
...
<button className="btnl mt-2">Forget Password</button>
</div>
    </div>
    </div>
    );
